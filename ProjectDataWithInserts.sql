...
MODIFY           Person ( children := INCLUDE Person WITH (first-name ="Bill" AND last-name = "Dawer")) WHERE first-name = "Mike" AND last-name = "Dawer" ;

MODIFY LIMIT = ALL Employee ( employee-manager := Manager WITH (first-name = "Bill"   AND last-name = "Dawer"))       WHERE employee-id = 102 OR employee-id = 106;
MODIFY LIMIT = ALL Employee ( employee-manager := Manager WITH (first-name = "Steven" AND last-name = "Williams"))    WHERE employee-id = 103 OR employee-id = 105;
MODIFY LIMIT = ALL Employee ( employee-manager := Manager WITH (first-name = "Henry"  AND last-name = "Silverstone")) WHERE employee-id = 101 OR employee-id = 107;
MODIFY LIMIT = ALL Employee ( employee-manager := Manager WITH (first-name = "Henry"  AND last-name = "Silverstone")) WHERE employee-id = 101 OR employee-id = 107;

MODIFY LIMIT = ALL Project-Employee ( current-projects := INCLUDE Current-Project WITH ( project-title = "Mission Impossible" )) WHERE person-id = 7 OR person-id = 3 OR person-id = 2 OR employee-id = 106 OR person-id = 1;
MODIFY LIMIT = ALL Project-Employee ( current-projects := INCLUDE Current-Project WITH ( project-title = "Stick And Fly" ))      WHERE person-id = 3 OR person-id = 7 OR person-id = 106;
MODIFY LIMIT = ALL Project-Employee ( current-projects := INCLUDE Current-Project WITH ( project-title = "Night Rider" ))        WHERE person-id = 2 OR person-id = 1 OR person-id = 7;

MODIFY Manager ( projects-managing := INCLUDE Project         WITH (project-title = "Mission Impossible" OR project-title = "Night Rider"), manager-dept := Department WITH ( dept-name = "Sales" )) WHERE employee-id = 101;
MODIFY Manager ( projects-managing := INCLUDE Project         WITH (project-title = "Stick And Fly"      OR project-title = "Code Red" OR project-title = "Desert Rose" OR project-title = "Hallo"), manager-dept := Department WITH ( dept-name = "R&D")) WHERE employee-id = 107;
MODIFY Manager ( manager-dept      :=         Department      WITH ( dept-name ="Sales")) WHERE employee-id = 108;

MODIFY Department ( project-at := INCLUDE Project WITH ( project-title= "Mission Impossible" OR project-title = "Night Rider")) WHERE dept-name = "Sales";
MODIFY Department ( project-at := INCLUDE Project WITH ( project-title= "Stick And Fly"      OR project-title = "Code Red" OR project-title = "Desert Rose" OR project-title = "Hallo")) WHERE dept-name = "R&D";

MODIFY Project ( sub-projects  := INCLUDE Project WITH ( project-title= "Stick And Fly" OR project-title = "Desert Rose")) WHERE project-title = "Code Red";